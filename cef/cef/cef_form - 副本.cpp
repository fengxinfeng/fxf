...
void CefForm::InitWindow()
{
	...
	cef_control_->AttachBeforeBrowser(nbase::Bind(&CefForm::OnBeforeBrowser, this, std::placeholders::_1,std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));

	cef_control_->AttachAfterCreated(nbase::Bind(&CefForm::OnAfterCreated, this, std::placeholders::_1));
